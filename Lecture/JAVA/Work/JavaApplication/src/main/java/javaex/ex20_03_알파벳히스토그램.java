...
public class ex20_03_알파벳히스토그램 {
    ...
    public static void main(String[] args) {
        ...
        String text = "This was a great help."
                ...
                + "I created an event scheduled every couple hours to rebuild a view that pivots n amount of "
                + "rows from one table into n columns on the other."
                + " It's a big help because before I was rebuilding the query using PHP on every execution of the SELECT. "
                + "Even though views can't leverage Indexes,"
                + " I'm thinking filtering performance won't be an issue as the pivoted rows"
