...
public class main extends JFrame {
    ...
    //    books = new ArrayList<>();
    //    books.add( new book(0, 박근혜출당, 출판사0, 장르0, 저자0, 15000, 대여정보0)) ;
    ...
    private JButton getBtnNewButton_3() {
        if (btnNewButton_3 == null) {
        	...
        	btnNewButton_3.setBounds(339, 10, 118, 50);
        }
    ...
    private JScrollPane getScrollPane() {
        if (scrollPane == null) {
        	...
        	scrollPane.setBounds(12, 70, 206, 408);
    ...
    private JComboBox getComboBox() {
        if (comboBox == null) {
        	...
        	comboBox.setModel(new DefaultComboBoxModel(new String[] {"회원번호"}));
    ...
    private JTable getTable_3() {
        if (table_3 == null) {
        	...
        	table_3.setModel(new DefaultTableModel(
        	    ...
        	    new String[] {
        	        "No.", "\uC774\uB984", "\uC804\uD654\uBC88\uD638", "\uC8FC\uBBFC\uBC88\uD638", "\uBA54\uC77C\uC8FC\uC18C", "\uCC45\uC81C\uBAA9", "\uCD9C\uD310\uC0AC", "\uC7A5\uB974", "\uC800\uC790", "\uCC45\uBC88\uD638", "\uB300\uC5EC\uB0A0\uC9DC"
        	    }
        	));
        }
        return table_3;
